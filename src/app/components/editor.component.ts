...
@Component({
  ...
  standalone: true,
  template: `
    <div class="bg-base00 border border-base02 p-5 rounded-lg shadow-xl flex gap-6 h-full overflow-hidden text-base">
      <div class="w-full h-full overflow-auto" [innerHTML]="safeCode"></div>
    </div>
  `,
  styles: `
    :host ::ng-deep .shiki {
